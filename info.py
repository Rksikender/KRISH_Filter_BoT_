...
auth_channel = environ.get('AUTH_CHANNEL', '-1001779982100')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001779982100')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Amresh:Amresh@cluster0.kpcic.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'KRISH)
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+GkGB4jgvSoFjZTg1')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1001779982100')
